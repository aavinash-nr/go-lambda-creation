...
func handler(ctx context.Context) (string, error) {
	...
	// // Attempt to allocate memory continuously
	// var bigList [][]byte

	// // Allocate a large chunk of memory in each iteration
	// for {
	// 	// Allocate 50 MB of memory in each iteration
	// 	bigList = append(bigList, make([]byte, 1000*1e6))
	// }
